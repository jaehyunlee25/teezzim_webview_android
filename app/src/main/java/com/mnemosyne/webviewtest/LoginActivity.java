...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 상단 타이틀 변경
        setTitle("teezzim login activity");
        ...
        String strResult = getPostCall(urlHeader + "login_admin", param);
    ...
    public String getPostCall(String url, String param) {
        postURL = url;
        postParam = param;
        LoginActivity.CallThread ct = new LoginActivity.CallThread();
        ct.start();
        try {
            ct.join();
        } catch(Exception e) {
