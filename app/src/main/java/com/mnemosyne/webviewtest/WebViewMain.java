...
public class WebViewMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // String strResult = getPostCall(urlHeader + "", param);
        String strResult = "";
        ...
        WebViewClient wvc = getSearchWebviewClient("javascript:()=>{};");
        ...
        wView.loadUrl("http://dev.mnemosyne.co.kr:1010/index.html");
    ...
    public String getPostCall(String url, String param) {
        postURL = url;
        postParam = param;
        WebViewMain.CallThread ct = new WebViewMain.CallThread();
        ct.start();
        try {
            ct.join();
        } catch(Exception e) {
